...
import DesignerSidebar from "./ManageDesignerSidebar"
...
class ManageDesignerConfig extends Component {
      ...
      let columns = [
        {
          ...
          selector: "img",
          // minWidth: "220px",
          cell: row => <img src={row.img} height="52" width="50" alt={row.name} />
        },
        {
          name: "Name",
          selector: "name",
