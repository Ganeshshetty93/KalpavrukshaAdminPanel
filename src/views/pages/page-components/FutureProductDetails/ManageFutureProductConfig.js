...
import FutureProductSidebar from "./ManageFutureProductSidebar";
...
class ManageFutureProductConfig extends Component {
  static getDerivedStateFromProps(props, state) {
    console.log(props, state);
    console.log(props.dataList.data.length, "1");
    console.log(state.data.length, "2");
    console.log(state.currentPage, "3");
    console.log(props.parsedFilter.page, "4");
    if (
  ...
  handleDelete = row => {
    ...
    if (this.state.data.length - 1 === 0) {
      let urlPrefix = this.props.thumbView
        ? "/data-list/manage-designer-view/"
        : "/data-list/list-view/";
      history.push(
  ...
  handlePagination = page => {
    ...
    let urlPrefix = this.props.thumbView ? "/designer-view" : "/designer-view/";
  ...
  render() {
    ...
    return (
      <div
        className={`data-list ${
          this.props.thumbView ? "manage-designer-view" : "list-view"
        }`}
      >
        <DataTable
          columns={columns}
